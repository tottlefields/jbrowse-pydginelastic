...
var PydginXY = declare( [WiggleBase, YScaleMixin],
 ...
 */
{
        ...
        dojo.forEach( pixels, function(p,i) {
            ...
            if( score <= canvasHeight || score > originY) { // if the rectangle is visible at all
                if( score <= originY ) {
                    ...
                    thisB._fillRectMod( context, i-3, score, 6, height);
                    ...
                    thisB._fillRectMod( context, i-3, top, 6,  height);
    ...
    _showPixelValue: function( scoreDisplay, score ) {
        if( typeof score == 'number' ) {
            ...
            scoreDisplay.innerHTML = score['feat'].id()+"<br />"+parseFloat( score['score'].toPrecision(6) );
            return true;
        }
        else {
            return false;
